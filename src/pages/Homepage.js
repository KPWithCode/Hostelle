...
// Dont just Travel...Travel Your Way 
    ...
    <h2 style={{position:'absolute', top:'8px', right:'16px', fontSize:'40px'}} className="float-right d-flex justify-content-center" >TRAVEL YOUR WAY</h2>
    ...
    <a href="/countries" style={{ position:'absolute',top: '80%', left:'45%', fontSize:'100px'}}><TiArrowSortedDown /></a>
